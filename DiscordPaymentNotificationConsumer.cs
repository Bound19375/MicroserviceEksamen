...
public class DiscordNotificationConsumer : IConsumer<KafkaNotificationMessage> 
{
    private readonly DiscordSocketClient _client = DiscordClient.GetDiscordSocketClient();
    private readonly 

    public DiscordNotificationConsumer()
    {

    }

    public async Task Consume(ConsumeContext<KafkaNotificationMessage> context) 
    {
